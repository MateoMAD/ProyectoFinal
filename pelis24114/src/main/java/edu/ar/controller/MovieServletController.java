...
public class MovieServletController extends HttpServlet {
  ...
  List<Peliculas> movieList = new ArrayList<>();
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    switch(route) {
      case "add"-> {
        ...
        Peliculas newMovie = new Peliculas(nombre, descripcion, genero, calificacion, anio, estrellas, director);
       
        //Hardcodeo una peli
        Peliculas hardMovie = new Peliculas("hard", "hard", "hard", 88, 88, (byte)3, director);
